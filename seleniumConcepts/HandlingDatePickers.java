...
public class HandlingDatePickers {
	...
	public static void pastDate(WebDriver driver, String month, String year, String date) throws InterruptedException {
...
//	}
	...
	public static void futureDate(WebDriver driver, String month, String year, String date) throws InterruptedException {
...
//		pastDate(driver,month,year,date);
		...
		futureDate(driver,fmonth,fyear,fdate);
